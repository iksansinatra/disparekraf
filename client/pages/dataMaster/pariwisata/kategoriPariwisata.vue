    ...
    <v-container>
      <v-card class="mx-auto" outlined>
        <v-row class="subBar" style="padding:10px" no-gutters>
          <v-col cols="12" md="4">
            <span class="h_judul">Kategori Pariwisata</span>
            <br />
          ...
          <template v-slot:default>
            ...
            <tbody>
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                ...
                <td class="text-center">{{data.m_bidangpariwisata_kode}}.{{data.kode}}</td>
                <td>
                  {{data.uraian}} <br>
                  <span class="h_subtitle">{{data.m_bidangpariwisata_uraian}}</span>
                </td>
          ...
          <v-card>
            ...
            <v-card-text>
                ...
                <div class="divInput">
                  ...
                  <v-autocomplete
                    v-model="form.m_bidangPariwisata"
                    :items="list_bidang"
                    :item-text="'uraian'"
                    :item-value="'id'"
                    outlined
  ...
  export default {
    ...
    methods: {
      ...
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_KATEGORI_PARIWISATA + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        ...
        fetch(this.$store.state.url.URL_DM_KATEGORI_PARIWISATA + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_DM_KATEGORI_PARIWISATA + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : async function(data){
        ...
        fetch(this.$store.state.url.URL_DM_KATEGORI_PARIWISATA + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      selectData : async function(data){
          ...
          this.form.m_bidangPariwisata = data.m_bidangPariwisata;
      ...
      // ====================================== PAGINATE ====================================
        ...
        fetching : async function(){
          this.list_bidang = await FETCHING.getBidangPariwisata()
          // console.log(this.list_bidang)
        }
