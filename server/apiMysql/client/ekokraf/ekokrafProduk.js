...
router.post('/dashboard', (req, res) => {
    ...
    let view = `
    SELECT * FROM ekokrafpelakuproduk
...
router.post('/produkLaris', (req, res) => {
...
router.post('/detailProduk', (req, res) => {
    console.log(req.body.id)
    let view = `
    SELECT ekokrafpelakuproduk.*,
    ...
    WHERE ekokrafpelakuproduk.id = '`+req.body.id+`';
...
router.post('/listProduk', (req, res) => {
